...
class PaymentMethodsService:
    ...
    async def create_payment_method(self,uow, payment_data: CreatePaymentMethodSchema) -> models.PaymentMethod:
    ...
    async def get_payment_methods(self, uow,) -> list[models.PaymentMethod]:
        async with uow:
            return await uow.payment_methods.get_all()
        
    async def get_payment_method_by_id(self,uow, id: int) -> models.PaymentMethod:
        async with uow:
            return await uow.payment_methods.get_by_id(id)
        
    async def update_payment_method(self, uow,id: int, payment_data: UpdatePaymentMethodSchema) -> models.PaymentMethod:
    ...
    async def delete_payment_method(self,uow, id: int) -> models.PaymentMethod:
        async with uow:
            payment_method: models.PaymentMethod = await uow.payment_methods.get_by_id(id)
