...
class ShowRoomsService:
    ...
    async def create_show_room(self,uow, show_room_data: CreateShowRoomSchema) -> models.ShowRoom:
        async with uow:
    ...
    async def get_show_rooms(self, uow,) -> list[models.ShowRoom]:
        async with uow:
            return await uow.show_rooms.get_all()
        
    async def get_show_room_by_id(self,uow, id: int) -> models.ShowRoom:
        async with uow:
            return await uow.show_rooms.get_by_id(id)
        
    async def update_show_room(self,uow, id: int, show_room_data: UpdateShowRoomSchema) -> models.ShowRoom:
        async with uow:
    ...
    async def delete_show_room(self,uow, id: int) -> models.ShowRoom:
        async with uow:
            show_room: models.ShowRoom = await uow.show_rooms.get_by_id(id)
